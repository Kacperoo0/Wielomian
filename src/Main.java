...
public class Main {
    public static void main(String[] args) {
        System.out.println("Podaj stopien danego wielomianu");
        ...
        for (int i = 0; i < arrayElements.length; i++) {
            System.out.println("Podaj wspolcznik stopnia: " + (arrayElements.length - i - 1) + " ");
        ...
        if (wynik) System.out.println("Jest pierwiastkiem");
        else System.out.println("Nie jest pierwiastkiem");
